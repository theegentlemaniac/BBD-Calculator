...
function buildActiveExpression() {
...
function scientific(fn) {
    ...
    const sourceValue = currentInput !== ""
        ...
        : lastResult !== null && lastResult !== void 0 ? lastResult : accumulator;
...
(_b = document.getElementById("clear")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", clearAll);
document.querySelectorAll(".sci").forEach(btn => {
    btn.addEventListener("click", () => {
        scientific(btn.dataset.fn);
    });
});
